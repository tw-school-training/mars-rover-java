...
public class MarsRoverTest {
    ...
    public void should_just_move_to_max_y_given_command_is_MM_and_facing_is_N_and_max_y_of_bound() {
        ...
        Position position = marsRover.execute("MM");
    ...
    @Test
    public void should_just_move_to_max_x_given_command_is_MM_and_facing_is_E_and_max_x_of_bound() {
        MarsRover marsRover = new MarsRover(Position.builder().x(0).y(0).direction(Direction.E).build(),
                Bound.builder().maxX(2).build());
    ...
    public void should_ignore_more_move_given_command_is_MMM_and_at_bound() {
        ...
        Position position = marsRover.execute("MMM");
    ...
    @Test
    public void should_return_correct_location_given_command_is_MMRMMM_facing_is_N_and_max_y_of_bound_is_2_and_max_x_of_bound_is_2(){
        MarsRover marsRover = new MarsRover(Position.builder().x(0).y(0).direction(Direction.N).build(),
                Bound.builder().maxY(2).maxX(2).build());

        Position position = marsRover.execute("MMRMMM");//y+1,y+1,E,x+1,x+1,x+1
